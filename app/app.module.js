...
angular
  ...
  .config([
    ...
    function config($locationProvider, $routeProvider) {
      ...
      $routeProvider
        .when("/", {
          template: `<div class="tasks-panel"><div class="active-tasks tasks">
            <active-task-list></active-task-list></div>
           <div class="completed-tasks tasks"> <completed-task-list></completed-task-list>
          </div></div>`
        })
        .when("/add", {
